        ...
        <div class="table-data" style="height: 500px;">
            <div class="order">
                ...
                <div class="row g-3 justify-content-start">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('exportpdfpenyakit') }}" class="btn btn-danger" target="_blank">Export PDF All</a>
                    </div>
                    <div class="dropdown col-auto">
                        ...
                        <form id="filter-form" class="dropdown-menu p-4" method="GET"
                            action="{{ route('filterdatapenyakit') }}">
                            @csrf
                            <div class="mb-3">
                    ...
                    <div class="dropdown col-auto">
                        ...
                        <form id="filter-form" class="dropdown-menu p-4" method="GET"
                            action="{{ route('exportpdfdatepenyakit') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="start_date" class="form-label">Start Date:</label>
                                <input type="date" class="form-control" name="start_date">
                    ...
                    <div class="dropdown col-auto">
                        ...
                        <form class="dropdown-menu p-4" method="GET" action="{{ route('filterdatapenyakit') }}">
                            @csrf
                            <div class="mb-3">
                    ...
                    <div class="dropdown col-auto">
                        ...
                        <form class="dropdown-menu p-4" method="GET" action="{{ route('exportpdfsearchpenyakit') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="search" class="form-label">Search :</label>
                                <input type="search" class="form-control" name="filtersearch" placeholder="Search...">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('importcsvpenyakit') }}" method="post"
                    ...
                    <table class="mt-4">
                        ...
                        <tbody>
                            ...
                            @foreach ($penyakit as $index => $p)
                                <tr>
                                    <td>{{ $index + $penyakit->firstItem() }}</td>
                                    <td>{{ $p->nama_pasien }}</td>
                                    <td>{{ $p->nik }}</td>
